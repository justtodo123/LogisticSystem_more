...
| **文档版本** | V1.0（MVP 架构设计） |
| **状态** | 架构基线（MVP 立项依据）；**P1 交付架构见 [V1.1 P1 交付版](./系统架构设计说明书-V1.1-P1交付版.md)** |
...
> **字段说明**：
> - `unallocated_packages`：未分配的包裹编码列表（可选）。当车辆不足时，部分包裹可能无法分配，这些包裹会保留在原节点，下次调用节点调度时自动处理。
...
| V1.1 | 2026-06-25 | **P1 交付版**见 [系统架构设计说明书-V1.1-P1交付版.md](./系统架构设计说明书-V1.1-P1交付版.md) | 项目组 |
