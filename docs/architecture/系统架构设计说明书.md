...
| 技术项 | 推荐选型 | 说明 | 备选 |
| --- | --- | --- | --- |
| 开发库 | **SQLite** | PRD 明确；零配置，单文件 `backend/data/logistics.db` | — |
...
| 数据库 | `backend/data/logistics.db` | Alembic 管理 schema 版本 |
| 配置 | `backend/.env` + `algorithm_config.json` | API Key 不入库、不进 Git |
